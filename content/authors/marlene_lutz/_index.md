...
education:
  courses:
  - course: PhD in Business Informatics 
...
- icon: envelope
  icon_pack: fas
  link: 'marlene.lutz@uni-mannheim.de'  # For a direct email link, use "mailto:debora.nozza@unibocconi.it".
- icon: bluesky
  icon_pack: fab
...
- icon: user
  icon_pack: fas
  link: https://marlenelutz.github.io/
- icon: linkedin
  icon_pack: falb
  link: https://www.linkedin.com/in/marlene-lutz-424035223/
