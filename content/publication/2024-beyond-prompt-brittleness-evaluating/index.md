...
publication_types:
- '2'
publication: Transactions of the Association for Computational Linguistics, Volume 12
...
categories: []
featured: false
url_pdf: https://aclanthology.org/2024.tacl-1.76/
url_code: ''
url_dataset: ''
url_poster: ''
url_project: ''
...
url_source: ''
url_video: ''
socialmedia_post: "'Beyond Prompt Brittleness' by @tanise et al (2024) presents a framework for robust evaluation of political biases, how model's biases scale with size, and the political biases of LLMs in fine-grained policy issues."
image:
  caption: ''
  focal_point: Center
  preview_only: false
